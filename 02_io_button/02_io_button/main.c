...
int main(void){
	...
	*/
	...
	/*
	// Task 2: Make a program which all LEDs are off at the start. It turns on Port B LEDs if PD0 button is clicked, the LEDs will be turned off if PD0 button is clicked again. And repeat this procedure. 
	DDRB = 0xFF;
	DDRD = 0x00;
	...
	*/
	...
	// Task4: Make a program which blinks PB0 at 10Hz. If any 2 buttons are pushed down, the program blinks PB7 at 20Hz.
	DDRB = 0xFF;
	DDRD = 0x00;
